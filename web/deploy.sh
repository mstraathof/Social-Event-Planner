...
SINGLETONS=(ElementList EditEntryForm NewEntryForm Navbar LoginWindow CreateAccountForm NavbarLoggedIn ProfilePage EditBio ViewComments NewCommentForm NewPassForm)
